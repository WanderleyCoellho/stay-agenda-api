...
import com.projeto.Repositories.CategoriasRepository;
...
public class CategoriasController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CategoriasModel> atualizarCategoria(@PathVariable Long id,
            @RequestBody CategoriasModel categoriaDetalhes) {
